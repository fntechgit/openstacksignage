...
<style>
    ...
    #app {
        width: 1080px;
        height: 1920px;
        background-image: url("~/assets/images/oc6-oculus/OC6_FNSIGN_Bkgd_200b.png");
    }    

    .room-671 {
        background-image: url("~/assets/images/oc6-oculus/OC6_FNSIGN_Bkgd_200b.png")!important;
    }
    .room-671 h1.time {
        color: rgb(186,1,255);
    }
