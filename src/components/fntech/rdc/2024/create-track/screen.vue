    ...
    <div id="app">
        ...
        <div :class="['events-wrapper', { 'justify-content': !hasCurrentAndNext }]" v-if="!endOfDay">
            ...
            <div class="title-room-wrapper">
                <div class="title">Create Track</div>
                <div class="room-label">{{ formatRoomName(schedule.room.name) || '210A' }}</div>
            </div>
        </div>
        <div class="end-of-day" v-if="endOfDay">
            <span class="message">This track is over for today</span>
            <span class="track">Create Track</span>
...
<style scoped>
    ...
    .track-background {
        background-image: url('~/assets/images/rdc/rdc24/FN-153_210A-Create_Bkg.png');
    }
