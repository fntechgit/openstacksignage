    ...
    <div id="app">
        ...
        <div :class="['events-wrapper', { 'justify-content': !hasCurrentAndNext }]" v-if="!endOfDay">
            ...
            <div class="title-room-wrapper">
                <div class="title">Grow Track</div>
                <div class="room-label">{{ formatRoomName(schedule.room.name) || '210C' }}</div>
            </div>
        </div>
...
<style scoped>
    ...
    .track-background {
        background-image: url('~/assets/images/rdc/rdc24/FN-154_210C-Grow_Bkg.png');
    }
